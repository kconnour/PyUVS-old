...
for counter, asdf in enumerate([-5, -4, -3, -2, -1, 0]):
    print(counter)
    ...
    print(reflectance[93, 63, :])

    ax[counter].plot(binned_wavelength_centers, l1c.reflectance[93, 63, :], label='franck')
    ax[counter].plot(binned_wavelength_centers, reflectance[93, 63, :], label='kyle')


plt.savefig('/home/kyle/ql_testing/many_shifts1.png')
