"""This module provides functions for finding data files on a computer.
"""
import math
...
def make_orbit_code(orbit: int) -> str:
    ...
    Examples
    --------
    >>> from pyuvs.data_files.path import make_orbit_code
...
def make_orbit_block(orbit: int) -> int:
    ...
    Examples
    --------
    >>> from pyuvs.data_files.path import make_orbit_block
...
def make_orbit_block_folder(orbit: int) -> str:
    ...
    Examples
    --------
    >>> from pyuvs.data_files.path import make_orbit_block_folder
